...
import { InsertDocument, GetAllDocuments, GetDocumentsWithRoot } from '../database/filesdb.js';
...
GetDocumentsWithRoot("/Users/thomasgascoyne/SelfHostedCloudDrive/RandoFolder").then(data => {console.log(data)});
// get_req('login.html')
